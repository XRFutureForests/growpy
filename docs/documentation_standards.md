...
| No code blocks in documentation files | Root docs define navigation and standards, not implementations |
...
| Line budget | AGENTS.md ≤200 lines; CLAUDE.md ≤50 lines |
...
| Stack adaptation | Use official Python, USD, and Unreal Engine docs for external links |
| Token efficiency | Prefer tables, short bullets, and direct links over long prose |
| English only | All documentation written in English |
...
| USD | https://openusd.org/docs/ |
| usd-core | https://pypi.org/project/usd-core/ |
| Unreal Engine 5 | https://dev.epicgames.com/documentation/en-us/unreal-engine/ |
...
- [ ] External doc links use official domains for the stack
