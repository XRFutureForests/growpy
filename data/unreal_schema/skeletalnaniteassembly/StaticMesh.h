...
#else
	inline void AcquireAsyncProperty(EStaticMeshAsyncProperties AsyncProperties = EStaticMeshAsyncProperties::All) {};
	inline void ReleaseAsyncProperty(EStaticMeshAsyncProperties AsyncProperties = EStaticMeshAsyncProperties::All) {};
	inline void WaitUntilAsyncPropertyReleased(EStaticMeshAsyncProperties AsyncProperties) const {}
#endif
...
public:
	...
	UE_DEPRECATED(5.7, "Please do not access this member directly, it will become private soon; use UStaticMesh::Get/SetLODGroup() or, if absolutely needed, UStaticMesh::SetLODGroup_Unsafe() which bypasses the conditional processing in SetLODGroup(). The Unsafe version is likely to be removed in the near future.")
	 ...
	 */
	UE_DEPRECATED(5.7, "Please do not access this member directly, it will become private soon; use UStaticMesh::GetNumStreamedLODs().")
	UPROPERTY()
	FPerPlatformInt NumStreamedLODs;

	/* The last import version */
	UE_DEPRECATED(5.7, "Please do not access this member directly, it will become private soon; use UStaticMesh::GetImportVersion() or UStaticMesh::SetImportVersion().")
	UPROPERTY()
	int32 ImportVersion;

	UE_DEPRECATED(5.7, "Please do not access this member directly, it will become private soon; use UStaticMesh::GetMaterialRemapIndexPerImportVersion()")
	UPROPERTY()
	...
	UE_DEPRECATED(5.7, "Please do not access this member directly, it will become private soon; use UStaticMesh::GetAutoComputeLODScreenSize() or UStaticMesh::SetAutoComputeLODScreenSize().")
	UPROPERTY()
	...
	*/
	UE_DEPRECATED(5.7, "Please do not access this member directly, it will become private soon; use UStaticMesh::GetRequiresLODDistanceConversion() or UStaticMesh::SetRequiresLODDistanceConversion().")
	 ...
	 */
	UE_DEPRECATED(5.7, "Please do not access this member directly, it will become private soon; use UStaticMesh::GetRequiresLODScreenSizeConversion() or UStaticMesh::SetRequiresLODScreenSizeConversion().")
	uint8 bRequiresLODScreenSizeConversion : 1;

	/** Materials used by this static mesh. Individual sections index in to this array. */
	UE_DEPRECATED(5.7, "Do not access this member. It is not meant to be used outside of UStaticMesh.")
	UPROPERTY()
	TArray<TObjectPtr<UMaterialInterface>> Materials_DEPRECATED;

	/** Settings related to building Nanite data. */
	UE_DEPRECATED(5.7, "Please do not access this member directly, it will become private soon; use the various NaniteSettings accessor functions.")
...
public:
	...
	PRAGMA_DISABLE_DEPRECATION_WARNINGS
	FName GetLODGroup() const
	{
		return LODGroup;
	}

	void SetLODGroup_Unsafe(FName InLODGroup)
	{
		LODGroup = InLODGroup;
	}
	...
	{
		return GET_MEMBER_NAME_CHECKED(UStaticMesh, LODGroup);
	}

	const FPerPlatformInt& GetNumStreamedLODs() const
	{
		return NumStreamedLODs;
	}

	FPerPlatformInt& GetNumStreamedLODs()
	{
		return NumStreamedLODs;
	}
	...
	void SetImportVersion(int32 Version)
	{
	...
	{
		return MaterialRemapIndexPerImportVersion;
	}

	void AddMaterialRemapIndex(const FMaterialRemapIndex& Index)
	{
		MaterialRemapIndexPerImportVersion.Add(Index);
	}

	bool GetAutoComputeLODScreenSize() const
	{
		return bAutoComputeLODScreenSize;
	}

	void SetAutoComputeLODScreenSize(bool bShouldCompute)
	{
		bAutoComputeLODScreenSize = bShouldCompute;
	}

	static FName GetAutoComputeLODScreenSizeMemberName()
	{
		return GET_MEMBER_NAME_CHECKED(UStaticMesh, bAutoComputeLODScreenSize);
	}

	bool GetRequiresLODDistanceConversion() const
	{
		return bRequiresLODDistanceConversion;
	}

	void SetRequiresLODDistanceConversion(bool bRequiresConversion)
	{
		bRequiresLODDistanceConversion = bRequiresConversion;
	}
	...
	void SetRequiresLODScreenSizeConversion(bool bRequiresConversion)
	{
		bRequiresLODDistanceConversion = bRequiresConversion;
	}

	const FMeshNaniteSettings& GetNaniteSettings() const
	{
	...
	void SetNaniteSettings(const FMeshNaniteSettings& Settings)
	{
	...
	{
		return GET_MEMBER_NAME_CHECKED(UStaticMesh, NaniteSettings);
	}
...
public:
	...
	/**
	 * Removes references previously cached using RecacheNaniteAssemblyReferences(). Must be called from the game thread.
	 */
	ENGINE_API void ClearCachedNaniteAssemblyReferences();
#endif
...
#endif
#if WITH_EDITOR
	void OnNaniteAssemblyReferenceBuilt(UStaticMesh* Reference);
#endif
...
public:
	...
	UE_DEPRECATED(5.7, "Please do not access this member directly, it will become private soon; use the various RayTracingProxySettings accessors.")
	UPROPERTY(EditAnywhere, Category = RayTracingProxySettings)
	FMeshRayTracingProxySettings RayTracingProxySettings;

	PRAGMA_DISABLE_DEPRECATION_WARNINGS
	const FMeshRayTracingProxySettings& GetRayTracingProxySettings() const
	{
		return RayTracingProxySettings;
	}
	FMeshRayTracingProxySettings& GetRayTracingProxySettings()
	{
		return RayTracingProxySettings;
	}
	void SetRayTracingProxySettings(const FMeshRayTracingProxySettings& Settings)
	{
		RayTracingProxySettings = Settings;
	}

	static FName GetRayTracingProxySettingsMemberName()
	{
		return GET_MEMBER_NAME_CHECKED(UStaticMesh, RayTracingProxySettings);
	}

	void NotifyRayTracingProxySettingsChanged()
	{
		FProperty* ChangedProperty = FindFProperty<FProperty>(UStaticMesh::StaticClass(), UStaticMesh::GetRayTracingProxySettingsMemberName());
		FPropertyChangedEvent Event(ChangedProperty);
		PostEditChangeProperty(Event);
	}
	PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	{
		return GET_MEMBER_NAME_CHECKED(UStaticMesh, bSupportRayTracing);
	}
...
public:
	...
	UE_DEPRECATED(5.7, "Please do not access this member directly, it will become private soon; use UStaticMesh::GetAssetImportData() or UStaticMesh::SetAssetImportData().")
	...
	UE_DEPRECATED(5.7, "Please do not access this member directly, it will become private soon; use UStaticMesh::GetThumbnailInfo() or UStaticMesh::SetThumbnailInfo().")
	...
	UE_DEPRECATED(5.7, "Please do not access this member directly, it will become private soon; use UStaticMesh::GetEditorCameraPosition() or UStaticMesh::SetEditorCameraPosition().")
	UPROPERTY()
	...
	UE_DEPRECATED(5.7, "Please do not access this member directly, it will become private soon; use UStaticMesh::GetCustomizedCollision() or UStaticMesh::SetCustomizedCollision().")
...
public:
	...
	{
		return GET_MEMBER_NAME_CHECKED(UStaticMesh, AssetImportData);
	}

	/**
	 * Get ThumbnailInfo for the static mesh
	 */
	...
	/**
	 * Set ThumbnailInfo for the static mesh
	 */
	...
	{
		return GET_MEMBER_NAME_CHECKED(UStaticMesh, ThumbnailInfo);
	}
	...
	void SetEditorCameraPosition(const FAssetEditorOrbitCameraPosition& Position)
	{
	...
	{
		return bCustomizedCollision;
	}

	void SetCustomizedCollision(bool bInCustomizedCollision)
	{
		bCustomizedCollision = bInCustomizedCollision;
	}
	PRAGMA_ENABLE_DEPRECATION_WARNINGS
...
public:
	...
	*/
	...
	struct FBuildParameters
	{
		...
		{
			bInSilent = Other.bInSilent;
			OutErrors = Other.OutErrors;
			bInRebuildUVChannelData = Other.bInRebuildUVChannelData;
			bInEnforceLightmapRestrictions = Other.bInEnforceLightmapRestrictions;

			PRAGMA_DISABLE_DEPRECATION_WARNINGS
			bIgnoreBoundsDiff = Other.bIgnoreBoundsDiff;
			PRAGMA_ENABLE_DEPRECATION_WARNINGS
		}
		...
		UE_DEPRECATED(5.7, "This option no longer has any effect and will be removed in a future release.")
...
private:
	...
	bool PollAsyncPhysicsTriMeshDataCheckComplex(bool InUseAllTriData, bool bInCheckComplexCollisionMesh) const;
