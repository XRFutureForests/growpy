            ...
            for fmt in formats:
                if fmt in ['usd', 'usda']:
                    ...
                    bpy.ops.export_scene.fbx(
                        ...
                        axis_forward='-Z',
                        axis_up='Y',
                        global_scale=1.0,  # 1:1 scale in meters (critical for proper size)
                        apply_scale_options='FBX_SCALE_ALL'  # Apply scale to all data
                    )
                    ...
                    if armature_obj:
                        ...
                        # CRITICAL: bake_anim=True required for Unreal skeletal mesh recognition
                        bpy.ops.export_scene.fbx(
                            ...
                            primary_bone_axis='Y',
                            secondary_bone_axis='X',
                            # CRITICAL for skeletal mesh recognition in Unreal (must be True!):
                            bake_anim=True,  # Required for skeletal mesh detection
