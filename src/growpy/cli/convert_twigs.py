...
Quick Start:
    ...
    python src/growpy/cli/convert_twigs.py data/assets/twigs --subdiv 40 --alpha-trim 0.02 --interior-decimate --decimate-ratio 0.2 --boundary-rings 2 --smooth-boundary --smooth-iterations 20 --smooth-factor 0.2
