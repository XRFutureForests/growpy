...
Quick Start:
    ...
    python src/growpy/cli/convert_twigs.py data/assets/twigs --subdiv 33 --alpha-trim 0.1 --interior-decimate --decimate-ratio 0.25 --boundary-rings 1 --smooth-boundary --smooth-iterations 20 --smooth-factor 0.25
