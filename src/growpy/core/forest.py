...
def simulate_forest_growth(
    forest_groves: ForestGroves, cycles: int, use_light_competition: bool = True
) -> None:
...
def get_forest_summary(forest_groves: ForestGroves) -> Dict[str, Any]:
    ...
    return {
        ...
        "species_distribution": {species: count for _, species, count in forest_groves},
    }
