...
- **config/__init__.py**: Reduced from 28 to 2 exports
- **core/__init__.py**: Reduced from 9 to 4 exports
- **io/__init__.py**: Reduced from 28 to 20 exports (removed metadata/nanite)
